...
namespace EngineTest.Unit
{
    public class ConfTest
    {
        ...
        public static FeatureModel Feature1 { get; } = new FeatureModel { Id = 1, Name = "feature_1", Type = Feature.Constants.STANDARD };
        public static FeatureModel Feature2 { get; } = new FeatureModel { Id = 1, Name = "feature_2", Type = Feature.Constants.STANDARD };
